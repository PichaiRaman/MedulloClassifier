...
signatureProbes <- readRDS("../results/model/bestFeaturesNewRNASeq.RDS")
medulloGeneSetsUp <- readRDS("../results/model/medulloSetsUpRNASeq.RDS")

#Function to remove underscore and split into two genes
getGenes <- function(x)
{
...
#Save RDS
saveRDS(medulloGeneSetsUp, "../results/model/medulloSetsUpGSE37418.RDS")
rm(list=ls());
