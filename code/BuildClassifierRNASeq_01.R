...
saveRDS(allGeneCombos, "../results/model/bestFeaturesNewRNASeq.RDS")
saveRDS(medulloGeneSetsUp, "../results/model/medulloSetsUpRNASeq.RDS")
saveRDS(list(geneRatioOut, sampAnnot), "../results/model/RNASeqDataForPlot.RDS")
rm(list=ls())
